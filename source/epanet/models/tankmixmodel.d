 ...
 *
 */
module epanet.models.tankmixmodel;
...
class TankMixModel
{
  public:
    ...
    alias MixingModel = int;

    static string[5] MixingModelWords = ["MIXED", "2COMP", "FIFO", "LIFO", null];
    ...
    // Methods
    void  init_(Tank tank, SegPool segPool, double _cTol){
        ...
        if ( firstSeg is null )
            throw new SystemError(SystemError.OUT_OF_MEMORY);
    ...
    double findFIFOQuality(double vNet, double vIn, double wIn, SegPool segPool){
        ...
        if ( vIn > 0.0 )
        {
            ...
            else
            {
                ...
                if ( seg is null ) throw new SystemError(SystemError.OUT_OF_MEMORY);
                if ( firstSeg is null ) firstSeg = seg;
        ...
        else if ( firstSeg is null ) cTank = 0.0;
