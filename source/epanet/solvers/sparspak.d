module epanet.solvers.sparspak;
...
void sp_smbfct(int neqns, int* xadj, int* adjncy, int* perm, int* invp,
            int *xlnz, ref int maxlnz, int* xnzsub, int* nzsub,
            ref int maxsub, int* rchlnk, int* mrglnk, int* marker,
            ref int flag)
{
  /* Local variables */
...
void sp_numfct(int neqns, int* xlnz, double* lnz, int* xnzsub, int* nzsub,
            double* diag, int* link, int* first, double* temp, ref int iflag)
{
